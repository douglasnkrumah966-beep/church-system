...
/* ============================================================
   STATION MEMBER CARD — Secretary
   Printable ID card for any member.
   ============================================================ */
...
<div class="id-card">
  ...
  <div class="id-card-body">
    ...
    <div class="id-details">
      ...
      <div class="id-row">
        <span class="id-label">Place of Birth</span>
        <span class="id-value"><?= e($member['place_of_birth'] ?: '—') ?></span>
      </div>
      <div class="id-row">
        <span class="id-label">Marital Status</span>
        <span class="id-value"><?= e($member['marital_status'] ?: '—') ?></span>
      </div>
      <div class="id-row">
...
.id-name {
  ...
  color: #2c5282; word-break: break-word;
}
.id-row {
